...
export default function Footer() {
  ...
  return (
    <footer className="villa-footer text-white py-3 md:py-4 px-2 md:px-4 transition-colors duration-300">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          <div className="text-center sm:text-left">
            <p className="text-white/90 text-xs md:text-sm">Tu lugar de relax en el corazón de Entre Ríos</p>
          </div>

          <div className="flex space-x-2 md:space-x-3">
            <button
              onClick={handleWhatsApp}
              className="w-7 h-7 md:w-8 md:h-8 bg-[#25D366] rounded-full flex items-center justify-center hover:scale-110 transition-transform duration-300"
            >
